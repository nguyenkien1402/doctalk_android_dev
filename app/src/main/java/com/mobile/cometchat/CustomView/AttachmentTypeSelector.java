package com.mobile.cometchat.CustomView;
...
import com.mobile.cometchat.Utils.ViewUtil;
...
public class AttachmentTypeSelector extends PopupWindow {
    ...
    public AttachmentTypeSelector(@NonNull Context context, @Nullable AttachmentClickedListener listener) {
        ...
        this.imageButton.setOnClickListener(new PropagatingClickListener(StringContract.ADD_GALLERY));
        this.audioButton.setOnClickListener(new PropagatingClickListener(StringContract.ADD_SOUND));
        this.documentButton.setOnClickListener(new PropagatingClickListener(StringContract.ADD_DOCUMENT));

        this.cameraButton.setOnClickListener(new PropagatingClickListener(StringContract.TAKE_PHOTO));
        this.videoButton.setOnClickListener(new PropagatingClickListener(StringContract.TAKE_VIDEO));
