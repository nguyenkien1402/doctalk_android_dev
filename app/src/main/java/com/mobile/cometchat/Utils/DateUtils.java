...
public class DateUtils {
    ...
    public static String getLastSeenDate(long timeStamp, Context context) {
        ...
        String lastSeenTime = new SimpleDateFormat("HH:mm a").format(new java.util.Date(timeStamp));
        String lastSeenDate = new SimpleDateFormat("dd/MM/yyyy").format(new java.util.Date(timeStamp));
