...
public class Messages {
    ...
    // User information
    public static String firebase_storage_avatar_path= "Avatars";
    public static String firebase_database_avatar_collection = "User_Avatar";
    public static String firebase_database_document_user_avatar = "Patient";
    public static String firebase_database_document_doctor_avatar= "Doctor";
